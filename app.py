...
if analyze_btn:
        ...
        if not success:
            ...
            with tab1:
                ...
                fig.add_trace(go.Candlestick(x=analyzer.data.index,
                                ...
                                name='Price'))
                fig.add_trace(go.Scatter(x=analyzer.data.index, y=tech['EMA_50'], line=dict(color='orange', width=1), name='EMA 50'))
                fig.add_trace(go.Scatter(x=analyzer.data.index, y=tech['EMA_200'], line=dict(color='blue', width=1), name='EMA 200'))
    ...
    st.info("Enter a coin symbol in the sidebar to begin analysis.")